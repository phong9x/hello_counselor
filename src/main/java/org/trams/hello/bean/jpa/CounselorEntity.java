...
@NamedQueries ( {
  @NamedQuery ( name="CounselorEntity.countAll", query="SELECT COUNT(x) FROM CounselorEntity x" )
} )
@DynamicInsert
@DynamicUpdate
public class CounselorEntity implements Serializable {
	...
	// "counselorCenterId" (column "counselor_center_id") is not defined by itself because used as FK in a link 
