...
<html>
	<head>
	    ...
	    <meta name="author" 		content="Minh Dang Le - bryanlee9889@gmail.com" />
	...
	<body class="page-header-fixed page-quick-sidebar-over-content face-talk">
		...
		<!--<script type="text/javascript" src="https://api.gooroomee.com/libs/meet/1.1.3/js/gooroomee-meeting-api.js"></script>-->
	    <script type="text/javascript" src="https://facetalk.hellowithyou.com:9443/libs/meet/1.1.3/js/gooroomee-meeting-api.js"></script>
	    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.0.6/handlebars.min.js"></script>
	    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js"></script>
	    <script type="text/javascript" src="/theme/admin/assets/js/facetalk.js"></script>
