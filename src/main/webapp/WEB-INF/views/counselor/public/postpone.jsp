                ...
                <div id="slide-register">
                    <div class="owl-carousel owl-theme">
                                    ...
                                    <div class="item-ct">
                                        <div class="item-top">
                                            ...
                                            <div class="item radio-checkboxstyle2">
                                                <input type="checkbox" id="terms1" checked="checked" /><span>동의합니다</span>
                                            </div>
                                        ...
                                        <div class="content">
                                            <p>HELLO 서비스 이용약관</p>
                                            <p>제1조(목적 등)</p>
                                            <p>아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요. 아래의 서비스 이용약관과 개인정보 취급방침 내용을 반드시 읽어 보시고 동의해 주세요.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item-main-content">
                                    <div class="item-ct">
                                        <div class="item-top">
                                            ...
                                            <div class="item radio-checkboxstyle2">
                                                <input type="checkbox" id="terms2"  checked="checked" /><span>동의합니다</span>
                                            </div>
                                            <div class="top-note terms_error" style="display:none">약관에 동의해주세요!</div>
                                        </div>
                                        <div class="content">
                        ...
                        <div class="item form-register">
                            <form id="form_register" method="post" action="/public/postpone" enctype="multipart/form-data">
                                <div class="item-main-content">
                                    <div class="item-main">
                                        <div class="item-top">
                                                ...
                                                <div class="md-content">
                                                    <div class="md-item">
                                                        ...
                                                        <div class="item-ct input-form">
                                                            <input type="text" name="email" class="form-control" value="${counselor.user.username}" disabled/>
                                                        </div>
                                                    </div>
                                                    <div class="md-item">
                                                        <span class="title">비밀번호</span>
                                                        <div class="item-ct input-form">
                                                            <input type="password" name="pwd" placeholder="8-20자 이내, 영문+숫자+특수문자 혼용" class="form-control" data-validate="false"/>
                                                    ...
                                                    <div class="md-item">
                                                        ...
                                                        <div class="item-ct input-form">
                                                            <input type="password" name="pwdConfirm" placeholder="8-20자 이내, 영문+숫자+특수문자 혼용" class="form-control" data-validate="false"/>
                                                            <span class="text-red notice" style="margin-left: 1em"></span>
                                                        </div>
                                                    </div>
                                                    <div class="md-item">
                                                        ...
                                                        <div class="item-ct input-form">
                                                            <input type="text" name="fullname" class="form-control" data-validate="${not empty counselor.user.fullname ? 'true' : 'false'}" value="${counselor.user.fullname}" />
                                                        </div>
                                                    </div>
                                                    <div style="height: 64px;" class="md-item">
                                                        <span class="title">휴대폰번호</span>
                                                        <div class="item-ct input-form">
                                                            <input type="text" name="mobilephone" placeholder="-없이 입력" class="form-control" data-validate="false"/>
                                                            <button class="register" id="btnSendToken">인증번호 발송</button>
                                                        </div>
                                                        <div class="item-ct input-form">
                                                            <input type="text" name="token" placeholder="인증번호 입력" class="form-control"/>
                                                        ...
                                                        <div class="item-ct input-form">
                                                            <div class="item-radio">
                                                                <div data-error-container="#form_2_services_error" class="checkbox-list input-checkboxstyle2">
                                                                    <label><input type="radio" value="2" name="counselType" class="radio1" ${counselor.user.userRole.id eq 2 ? 'checked' : ''} /></label>
                                                                </div>
                                                                <span class="note-radio">개인</span>
                                                            </div>
                                                            <div class="item-radio">
                                                                <div data-error-container="#form_2_services_error" class="checkbox-list input-checkboxstyle2">
                                                                    <label><input type="radio" value="3" name="counselType" class="radio1" ${counselor.user.userRole.id eq 3 ? 'checked' : ''} /></label>
                                                                </div>
                                                                <span class="note-radio">센터 소속</span>
                                                            </div>
                                                            <div class="item-select style2">
                                                                <select name="counselCenter" class="form-control selectpickermember" ${counselor.user.userRole.id ne 3 ? 'disabled' : ''}>
                                                                    <option value="0">센터 선택</option>
                                                                    <c:forEach items="${businesses}" var="item">
                                                                        <option value="${item.id}" ${counselor.counselingCenter.id eq item.id ? 'selected' : ''}>${item.centerName}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="list-main">
                                                                        <div class="item-main">
                                                                            ...
                                                                            <div class="item-main-ct">
                                                                                <button class="register btnDipFile" ${certificateIndex eq 999 ? 'disabled' : ''}>자격증 사본 등록</button>
                        ...
                        <div class="item slide3">
                            ...
                            <div class="main-submit">
                                <button id="btnRegister3" onclick="window.location='/'">
                                    <span>처음으로</span>
                                </button>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                ...
                <div class="item">
                    <div class="item-left">
                        ...
                        <div class="content"><span>수익 </span><span>분배 </span></div>
                    </div>
                    <div class="item-right">
                        <p>. 상담 비용은 심리상담사의 경력이나 내담자의 만족도 등 내부 정책에 따라 차등 설정될 수 있으며 수익 분배는 상담 비용의 70~80% 지급 (세금 별도)</p>
                    </div>
                </div>
                <div class="item">
                    <div class="item-left">
    ...
    $(document).ready(function() {
        ...
        *******************************************************/
        $('#btnRegister1').on('click', function(evt) {
            ...
            isError = !$terms1.is(':checked');
            if (isError) {
                $terms1.closest('.item').next('.terms_error').css('display', '');
            }

            isError = !$terms2.is(':checked');
            if (isError) {
